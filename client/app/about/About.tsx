...
const About = () => {
  return (
    <div className="text-black dark:text-white min-h-[80vh] text-4xl">
      <br />
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Academia, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of Academia, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created Academia &ndash; to provide new programmers
          with the resources and support they need to succeed.
          <br />
          <br />
          At Academia, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Academia is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Academia by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the Academia family today and let&apos;s
